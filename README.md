...
Here is a collection of quick references and cheat sheets for assisting development with git. Even though there are a lot of tools around which works on top of git, this cheat sheet will tell you how to work
